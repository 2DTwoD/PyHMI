...
class DActuator:
    ...
    def change_screen(self):
        if self.sc.current_screen in self.location:
            ...
            self.sc.screen_add_image(x, y, self.status_img[self.plc_data.status.get()])
    ...
    def _change_status(self):
        ...
        self.sc.screen_add_image(location.x, location.y, self.status_img[self.plc_data.status.get()])
